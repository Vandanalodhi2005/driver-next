    ...
    <footer className="bg-slate-950 text-slate-300 border-t border-slate-800/80 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-4">
            <Link href="/" className="flex items-center gap-3 group inline-flex">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white shadow-lg shadow-blue-500/20 group-hover:scale-105 transition-transform duration-200">
            ...
            <div className="pt-2">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-900 border border-slate-800 text-xs text-slate-300">
                ...
                <span>100% Independent Educational Content</span>
              </div>
            </div>
          </div>
            ...
            <ul className="space-y-2.5 text-sm">
              {siteConfig.footerLinks.siteLinks.map((link) => (
                <li key={link.title}>
                  ...
                  >
                    <ChevronRightIcon className="w-3.5 h-3.5 text-slate-600 group-hover:text-blue-400 group-hover:translate-x-0.5 transition-all" />
              ...
              {siteConfig.footerLinks.driverOverviews.map((link) => (
                <li key={link.title}>
                  <Link
                    ...
                    className="text-slate-400 hover:text-white transition-colors flex items-center gap-1.5 group"
                  >
                    <ChevronRightIcon className="w-3.5 h-3.5 text-slate-600 group-hover:text-indigo-400 group-hover:translate-x-0.5 transition-all" />
                    <span>{link.title}</span>
                  </Link>
                </li>
              ))}
              ...
              {siteConfig.footerLinks.legal.map((link) => (
                <li key={link.title}>
                  <Link
                    ...
                    className="text-slate-400 hover:text-white transition-colors flex items-center gap-1.5 group"
                  >
                    <ChevronRightIcon className="w-3.5 h-3.5 text-slate-600 group-hover:text-slate-300 group-hover:translate-x-0.5 transition-all" />
                    <span>{link.title}</span>
                  </Link>
                </li>
              ))}
            ...
            <div className="space-y-3 pt-1 text-xs">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-blue-400 hover:text-blue-300 transition-colors flex items-center gap-1.5 break-all"
                >
        ...
        <div className="mt-12 pt-8 border-t border-slate-900">
          <div className="rounded-2xl bg-slate-900/90 border border-slate-800/80 p-4 sm:p-5">
        ...
        <div className="mt-8 pt-6 border-t border-slate-900/80 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">

  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="prose prose-invert max-w-none space-y-6 text-slate-300 text-sm leading-relaxed">
        <section>
          <h2 className="text-xl font-bold text-white mb-2">1. Overview &amp; Data Controller</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-white mb-2">3. Cookies and Web Beacons</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-white mb-2">5. Contact Us Regarding Privacy</h2>
          <p>
            If you have questions regarding this Privacy Policy, you may contact our Data Officer at <a href={`mailto:${siteConfig.company.email}`} className="text-blue-400 hover:underline">{siteConfig.company.email}</a>.
          </p>
        </section>
      </div>
    </div>
